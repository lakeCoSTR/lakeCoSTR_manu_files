...
Since Lake Sunapee is well-instrumented and the data available ... we test varying datasets for validation to help show how much data is needed for validation and to try to make suggestions about the *in-situ* data needed for validation.
