...
=======
## Summary of lst data; filter our freezing temp; unimodal only; temp spread acceptable
>>>>>>> Stashed changes
...
validation$pred_temp = val_mean_dem$coefficients[1] + val_mean_dem$coefficients[2]*validation$temp_med
